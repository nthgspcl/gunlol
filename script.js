...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if(homeButton) {
    ...
    homeButton.addEventListener('touchstart', (e) => { e.preventDefault(); switchTheme('https://cdn.pixabay.com/video/2022/11/14/139010-770938030_large.mp4', backgroundMusic, 'home-theme'); });
  }
  ...
  if(hackerButton) {
    ...
    hackerButton.addEventListener('touchstart', (e) => { e.preventDefault(); switchTheme('https://cdn.pixabay.com/video/2023/01/10/146064-788138380_large.mp4', hackerMusic, 'hacker-theme', hackerOverlay, false); });
  }
  ...
  if(rainButton) {
    ...
    rainButton.addEventListener('touchstart', (e) => { e.preventDefault(); switchTheme('https://cdn.pixabay.com/video/2021/02/17/65496-514501840_large.mp4', rainMusic, 'rain-theme', snowOverlay, true); });
  }
  ...
  if(animeButton) {
    ...
    animeButton.addEventListener('touchstart', (e) => { e.preventDefault(); switchTheme('https://cdn.pixabay.com/video/2020/04/25/37137-412292784_large.mp4', animeMusic, 'anime-theme'); });
  }
  ...
  if(carButton) {
    ...
    carButton.addEventListener('touchstart', (e) => { e.preventDefault(); switchTheme('https://cdn.pixabay.com/video/2020/04/25/37137-412292784_large.mp4', carMusic, 'car-theme'); });
  }
  ...
  if(resultsButton) {
    ...
    resultsButton.addEventListener('touchstart', (e) => { e.preventDefault(); handleResultsToggle(); });
  }
