...
// Tự động chèn hộp Discord vào ngay trên đường kẻ ngang <hr> sau khi trang tải xong
document.addEventListener("DOMContentLoaded", function () {
    // 1. Tìm đường gạch ngang <hr> ngăn cách các link mạng xã hội
    const hrTag = document.querySelector("hr");
    
    if (hrTag) {
        // 2. Tạo một thẻ div mới cho hộp Discord
        const discordBox = document.createElement("div");
        discordBox.className = "discord-status-box";
        
        // 3. Đưa cấu trúc nội dung hiển thị vào trong hộp
        discordBox.innerHTML = `
            <div class="discord-avatar-wrapper">
                <img class="discord-avatar" src="https://cdn.discordapp.com/embed/avatars/0.png" alt="Discord Avatar">
                <div class="discord-online-dot"></div>
            </div>
            <div class="discord-info-text">
                <div class="discord-username">_dunlai</div>
            </div>
            <div class="discord-right-tag">
                <svg class="mini-discord-icon" viewBox="0 0 127.14 96.36" style="width:14px; height:14px; fill:currentColor; margin-right:5px; opacity:0.4;">
                    <path d="M107.7,8.07A105.15,105.15,0,0,0,77.26,0a77.19,77.19,0,0,0-3.3,6.83A96.67,96.67,0,0,0,53.22,6.83,77.19,77.19,0,0,0,49.88,0,105.15,105.15,0,0,0,19.44,8.07C3.66,31.58-1.86,54.65,1,77.53A105.73,105.73,0,0,0,32,96.36a77.7,77.7,0,0,0,6.63-10.85,68.43,68.43,0,0,1-10.5-5c.9-.65,1.76-1.34,2.58-2a75.58,75.58,0,0,0,93,0c.82.71,1.68,1.4,2.58,2a68.32,68.32,0,0,1-10.5,5,77.7,77.7,0,0,0,6.63,10.85,105.73,105.73,0,0,0,31.39-18.83C129.87,49.67,123.71,26.84,107.7,8.07ZM42.45,65.69C36.18,65.69,31,60,31,53S36.18,40.36,42.45,40.36,53.83,46,53.83,53,48.72,65.69,42.45,65.69Zm42.24,0C78.41,65.69,73.24,60,73.24,53S78.41,40.36,84.69,40.36,96.07,46,96.07,53,91,65.69,84.69,65.69Z"/>
                </svg>
                <span>discord info</span>
            </div>
        `;
        
        // 4. Lệnh insertBefore sẽ ép hộp Discord luôn đứng NGAY TRÊN thanh gạch ngang <hr>
        hrTag.parentNode.insertBefore(discordBox, hrTag);
    }
});
